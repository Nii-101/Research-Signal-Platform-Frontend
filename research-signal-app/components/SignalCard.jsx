...
const SignalCard = ({signal}) => {
  return (
    <Card className="flex flex-col bg-inherit shadow-md rounded-xl px-2 md:px-6 py-6 md:py-8 space-y-6 md:space-y-7">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h2 className="text-lg font-semibold">{signal.ticker}</h2>
          <span className="text-xs bg-[#d8e6f4] text-gray-600 px-2 py-1 rounded-[3px]">
            {signal.strategy}
          </span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-4 gap-1 max-md:overflow-x-scroll md:gap-3">
        <Card className="p-1 py-3 text-center bg-[#dcebf9] rounded-lg">
          ...
          <p className="md:text-xl font-bold text-gray-900">2.15</p>
        </Card>
        <Card className="p-1 py-3 text-center bg-[#dcebf9] rounded-lg">
          <p className="text-xs text-gray-500">VRP Ratio</p>
          <p className="md:text-xl font-bold text-gray-900">1.25</p>
        </Card>
        <Card className="p-1 py-3 text-center bg-[#dcebf9] rounded-lg">
          <p className="text-xs text-gray-500">Expected Return</p>
          <p className="md:text-xl font-bold text-gray-900">12.5%</p>
        </Card>
        <Card className="p-1 py-3 text-center  bg-[#d2e6fc] rounded-[3px] border border-slate-200">
          <p className="text-xs text-gray-500">Confidence</p>
          <p className="md:text-xl font-bold text-gray-900">85%</p>
        </Card>
      </div>
